      ...
      try {
        ...
        document.addEventListener("mousedown", (event) => {
          if (
            ...
            deleteListRef.current !== null &&
            deleteToDoRef.current !== null
          ) {
        ...
        <form>
          <div ref={toDoRef} className="modal-content">
            <CreateToDoC
              list={list}
              toDoModal={toDoModal}
              setNewToDo={(newToDo) => setNewToDo(newToDo)}
            />
          </div>
        </form>
      </div>
        ...
        <form>
          <div ref={editRef} className="modal-content">
            <EditToDoC
              ...
              book={book}
              recipe={recipe}
              editToDo={(newToDo) => setNewToDo(newToDo)}
            />
          </div>
        </form>
      </div>
      ...
      <div className="grid-center align-horizontal">
        {toDoList.map((list) => {
          return (
            <div
              key={list}
              className="grid grid-center container list-container"
            >
              <div
                ...
                <div>
                  {toDos.map((toDo, index) => {
                    if (list === toDo.list && toDo.dueDate === currentDay) {
                      ...
                      list === toDo.list &&
                      toDo.dueDate.slice(5, 7) === currentMonth
                    ) {
                      return (
